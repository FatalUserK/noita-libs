...
function TEST(num)
	...
	for i, j in ipairs(t) do --print table
		...
		for l = 1, 36 - string.len(material_name) do
			material_amount = ' ' .. material_amount
		end
		for l = 1, 12 - string.len(tostring(material_amount)) do
			material_percent = ' ' .. material_percent
		end
		for l = 1, 16 - string.len(material_percent) do
			material_percent_rounded = ' ' .. material_percent_rounded
		end
		print(material_name .. " = " .. material_amount .. ", " .. material_percent .. "%, " .. material_percent_rounded .. "%")
	end
end
